---
title: "Update"
description: "Learn how to update TeamplGPT"
---
...
- Stop the container currently running TeamplGPT so the port is freed.
...
You should always deploy or start the TeamplGPT container using the command found in [our local docker setup](/installation/self-hosted/local-docker#recommend-way-to-run-dockerized-anythingllm)
