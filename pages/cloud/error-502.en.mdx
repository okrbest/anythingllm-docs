---
title: "502 Error on TeamplGPT Hosted"
...
<Callout type="warning" emoji="️⚠️">
  **Notice**
  This page only applies to the Hosted Cloud version of TeamplGPT and only applies to those using the built-in embedder model.
...
### I am getting a 502 on my hosted TeamplGPT!
...
<Image
  ...
  width={500}
  quality={100}
  alt="TeamplGPT Subscription Item"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="TeamplGPT Subscription Dashboard"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="TeamplGPT Subscription Reboot"
/>
