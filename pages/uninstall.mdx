---
title: "Uninstall"
description: "Learn how to completely uninstall TeamplGPT"
---
...
Open your `Finder` and navigate to the `Applications` folder. Then, drag the TeamplGPT application into the `Trashcan`, and the application will be uninstalled.

To remove all TeamplGPT desktop data from your system, please also delete the `/Library/Application Support/anythingllm-desktop` folder. This folder is where your database, documents, and vector cache are located.
...
Utilize the uninstallation `executable` located in `/Users/{user}/AppData/Local/Programs/TeamplGPT` (or) `/Users/{user}/AppData/Local/Programs/anythingllm-desktop`
