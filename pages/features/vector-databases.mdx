...
description: "TeamplGPT allows you to use a host of LLM providers for chatting and generative AI."
---
...
TeamplGPT comes with a private built-in vector database powered by [LanceDB](https://lancedb.com/). Your vectors never leave TeamplGPT when using the default option.
