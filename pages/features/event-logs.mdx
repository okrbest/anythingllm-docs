...
The Event Logs page in TeamplGPT allows users to view and monitor various events that occur within the application.
...
Useful for monitoring your TeamplGPT instance.
