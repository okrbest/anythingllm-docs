...
description: "This guide explain how to setup AI Agents on TeamplGPT"
---
...
<Callout type="info" emoji="️ℹ️">
  **Note**
    ...
    TeamplGPT supports a lot of LLM providers for use with `@agent`s and you can see all the supported LLMs from [here](https://docs.useanything.com/features/language-models#supported-language-model-providers)
...
**That's it! You can now use TeamplGPT's Agents!**
