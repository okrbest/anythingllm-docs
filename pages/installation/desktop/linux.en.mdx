...
➤ TeamplGPT is built on an Ubuntu system and may not work well on other distros.
...
➤ We want to have Linux OS's to have the same experience with TeamplGPT.

</Callout>

## Downloading the installation file

Here is the download links for the latest version of TeamplGPT Linux.
...
After downloading the Linux `.AppImage` for TeamplGPT, you may need to give the file executable permissions so that it can run.
