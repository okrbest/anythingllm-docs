...
description: "TeamplGPT offers two main ways to use TeamplGPT. There are some distinct differences in functionality between each offering"
---
...
TeamplGPT is a "**single-player**" application you can install on any Mac, Windows, or Linux operating system and get local LLMs, RAG, and Agents with little to zero configuration and full privacy.

You can install TeamplGPT as a Desktop Application, Self Host it locally using Docker and Host it on cloud (aws, google cloud, railway etc..) using Docker

## Docker vs Desktop Version

TeamplGPT offers two main ways to use TeamplGPT. There are some distinct differences in functionality between each offering. Both are open source.

### You want TeamplGPT Desktop if...
...
### You want TeamplGPT Docker if...

- You need an easy setup, but server-based service for TeamplGPT to use local LLMs, RAG, and Agents locally
- You want to run an TeamplGPT instance that many people can use at the same time
...
- You want to access TeamplGPT from the browser
...
<Callout type="info" emoji="️💡">
  **Tip:** TeamplGPT Desktop is the easiest way to use TeamplGPT.
</Callout>
