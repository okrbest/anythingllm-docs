...
<Callout type="error" emoji="️‼️">
  **Caution!**
    ...
    You should prevent "hopping" between vector databases. TeamplGPT will not automatically port over your already embedded information.

    You would need to delete and re-embed each document in every workspace to migrate to another vector database.

</Callout>

TeamplGPT supports many vector databases providers out of the box.
