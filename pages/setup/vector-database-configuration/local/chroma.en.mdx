...
TeamplGPT can connect to your local or cloud-hosted Chroma instance running so that TeamplGPT can store and search embeddings on it automatically.
...
<Callout type="warning" emoji="️⚠️">
  **Developer Notice**
    ...
    TeamplGPT will use the embedding model set and **will not** use Chroma's built-in embedders even if defined.
