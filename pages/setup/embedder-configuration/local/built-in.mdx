---
title: "TeamplGPT Default Embedder"
description: "TeamplGPT ships with a built-in embedder model that runs on CPU"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="TeamplGPT Default Embedder"
/>

# TeamplGPT Default Embedder
...
TeamplGPT ships with a built-in embedder model that runs on CPU.
