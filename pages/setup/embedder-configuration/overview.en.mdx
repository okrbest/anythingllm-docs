...
TeamplGPT supports many embedding model providers out of the box with very little, if any setup.

You can modify your embedding provider and model at any time in TeamplGPT. However doing so can result in broken queries and needing to re-embed uploaded and stored documents.
