...
const config: DocsThemeConfig = {
  ...
  docsRepositoryBase:
    "https://github.com/Mintplex-Labs/anythingllm-docs/tree/main", // Repo link for the 'Edit this page'
  footer: {
    text: (
      <span>
  ...
  banner: {
    ...
    text: (
      <a href="https://useanything.com/download" target="_blank">
        🚀 TeamplGPT v1.5.8 is out. Update now →
      </a>
    ),
  },
  i18n: [
